				...
				for (int c = 0; c < 10; c++) {
					...
					for (int d = 0; d < 10; d++) {
						...
						for (int e = 0; e < 10; e++) {
							...
							if ((a * 10000 + b * 1000 + c * 100 + d * 10 + e) == (factA
									+ factB + factC + factD + factE)
									&& a > 0) {
								sumOfFactorialOfDigits += (a * 10000 + b * 1000
										+ c * 100 + d * 10 + e);
							}
						}
						if ((a * 1000 + b * 100 + c * 10 + d) == (factA + factB
								+ factC + factD)) {
							sumOfFactorialOfDigits += (a * 1000 + b * 100 + c
									* 10 + d);
						}
					}
